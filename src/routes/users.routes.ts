...
const models: TsoaRoute.Models = {
  ...
  User: {
    properties: {
      ...
      hobbies:{dataType: "string", required: true}
    },
  },
};
...
export function UserRoutes(app: express.Express) {
  ...
  app.put("/users/:id", function (request: any, response: any, next: any) {
    const args = {
  ...
  app.delete("/users/:id", function (request: any, response: any, next: any) {
    const args = {
      id: { in: "path", name: "id", required: true, dataType: "string" },
    };
